...
We cite a timeline of papers in Table 1 that have investigated, evaluated and reviewed racial bias in facial recognition systems in table one. Of note is the absence of study directly related to the impact of hyper-parameter variation.
...
The hyper-parameters we intend to study are:
...
\begin{figure}[hbt!]\captionsetup[subfigure]{font=footnotesize}
  ...
  \begin{minipage}{.45\columnwidth}
    \centering
    \includegraphics[width=\linewidth]{latex/images/4Layers_3Kernel_4Layers_5Kernel.png}
  ...
  \begin{minipage}{.45\columnwidth}
     \centering
    \includegraphics[width=\linewidth]{latex/images/8Layers_3Kernel_8Layers_5Kernel.png}
...
However, with a fixed kernel size of 5x5, and the same layer configuration, we observed an increase in the bias score between four and eight layers, and a significant decrease when the number of layers was increased from eight to ten. Generally, all results with a 5x5 kernel had worse bias scores at the same layer configurations as their 3x3 counterparts which aligns with the findings in kernel size comparisons previously noted.
