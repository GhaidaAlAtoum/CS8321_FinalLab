...
\begin{figure}[htbp]
    \centerline{\includegraphics[width=1\linewidth]{Matrix.png}}
...
\begin{figure}[htbp]
    \centerline{\includegraphics[width=1\linewidth]{8_conv_layers_3x3Filters_noFlat.png}}
...
\begin{figure}[htbp]
    \centerline{\includegraphics[width=1\linewidth]{8_conv_layers_5x5Filters_noFlat.png}}
...
\begin{figure}[htbp]
    \centerline{\includegraphics[width=1\linewidth]{16_conv_layers_3x3Filters_noFlat.png}}
    \caption{Variation 2: Kernel size 3x3 with 16 layers.}
    \label{var3}
\end{figure}

\begin{figure}[htbp]
    \centerline{\includegraphics[width=1\linewidth]{16_conv_layers_5x5Filters_noFlat.png}}
...
\begin{figure}[htbp]
    \centerline{\includegraphics[width=0.9\linewidth]{VGG19.png}}
    \caption{VGG19 ROC and Bias Score.}
    \label{vgg19_roc}
\end{figure}

\begin{figure}[htbp]
    \centerline{\includegraphics[width=0.9\linewidth]{VGG16.png}}
...
\begin{figure}
    \centerline{\includegraphics[width=0.8\linewidth]{heatmap.png}}
...
\begin{figure}
    \centerline{\includegraphics[width=0.8\linewidth]{fairFaceOriginalDistribution.png}}
...
\begin{figure}
    \centerline{\includegraphics[width=0.8\linewidth]{RegroupDistributionFairFace.png}}
